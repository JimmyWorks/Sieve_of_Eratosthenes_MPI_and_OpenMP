// Sieve of Eratosthenes with MPI and OpenMP
// Author: Jimmy Nguyen
// Email: jimmy@jimmyworks.net
//
// Program Description:
// Create a program which utilizes the "Sieve of Eratosthenes" algorithm
// to find all the primes up to the Nth integer.  The program returns
// the number of prime numbers found.  Multiple compute nodes can be utilized
// with Open MPI commands and further optimized with OpenMP.
...
int main(int argc, char** argv) {
  ...
  //// Check input arguments
    ...
    if(argc == 3 && !strcmp(argv[2],"DEBUG")) // Turn on debug mode
    {
       debug = 1;
    }
